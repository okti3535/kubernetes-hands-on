...
spec: # istenilen durum
  ...
  - name: mynginx
    ...
    - containerPort: 80
```
# docker run --name mypod -p 80:80 nginx komutu ile ayni isi yapar 
...
```
# label i container-info olanların deploy replicaset ve podlarini getirir
...
```
# clarus-deploy isimli deployment in imajini versiyon 2 ile degistirme
